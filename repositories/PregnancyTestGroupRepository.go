...
func (r *PregnancyTestGroupRepository) Init() {
	selectQuery := util.NewSelectQuery(util.SELECT, *util.NewGroup("id", "test_date", "number_entries", "number_pregnants")).
	    From("pregnancy_test_groups")

	insertQuery := util.NewInsertQuery("pregnancy_test_groups", "id", "test_date", "number_entries", "number_pregnants")
	updateQuery := util.NewUpdateQuery("pregnancy_test_groups", "id", "test_date", "number_entries", "number_pregnants")
